    ...
    <div className="about-container">
      <section className="bg-white  py-20 text-left">
       ...
       <div className='px-20 mt-10'>
        ...
        <button className="bg-gradient-to-br from-[#76efff] to-[#00ccff] hover:from-indigo-600 hover:via-sky-600 hover:to-emerald-600 text-white rounded-[50px] px-6 py-3 shadow-lg transition-all duration-300 ml-4"> Connect with us</button>
       </div>
